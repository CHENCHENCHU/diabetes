...
<body class="hold-transition skin-blue sidebar-mini">
		...
		<div class="content-wrapper">
			<div class="panel panel-primary">
				<div class="panel-heading">
					<strong><i class="fa fa-list"></i>&nbsp;用户列表</strong>
				</div>
				<div class="panel-body">
					<table class="table table-hover">
						...
						<tr>
							...
							<td><a href="pages/back/member/member_password.jsp"><input
									type="button" id="changeBut-admin" name="changeBut-admin"
									value="修改密码" class="btn btn-xs btn-default"></a></td>
							<td><a href="pages/back/member/member_edit.jsp"><input
									type="button" id="edit-admin" name="edit-admin" value="编辑"
									class="btn btn-xs btn-primary"></a></td>
							<td><input type="button" id="statusBut-admin-lock"
								name="lockBut-admin" value="锁定账户" class="btn btn-xs btn-danger"></td>
						</tr>
						<tr>
							...
							<td><a href="pages/back/member/member_password.jsp"><input
									type="button" id="changeBut-mermaid" name="changeBut-mermaid"
									value="修改密码" class="btn btn-xs btn-default"></a></td>
							<td><a href="pages/back/member/member_edit.jsp"><input
									type="button" id="edit-mermaid" name="edit-mermaid" value="编辑"
									class="btn btn-xs btn-primary"></a></td>
							<td><input type="button" id="statusBut-mermaid-active"
								name="lockBut-mermaid" value="激活账户"
	...
	<div class="modal fade" id="memberPasswordInfo" tabindex="-1"
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h3 class="modal-title">
						<span class="glyphicon glyphicon-folder-open"></span> <strong>修改“<span
							id="midTitleSpan"></span>”用户密码
						</strong>
					</h3>
				</div>
								...
								<div class="form-group" id="passwordDiv">
									...
									<div class="col-md-5">
										<input type="text" name="password" id="password"
											class="form-control input-sm" placeholder="请输入新密码">
									</div>

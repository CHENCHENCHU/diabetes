...
<div id="carouselMenu" class="carousel slide" data-interval="200" data-wrap="true">
	...
	<div class="carousel-inner"> 
		<div class="item active"><a href="http://" target="_ablank"><img src="images/ad/diabetes.jpg" alt="f1Img"></a></div>
		<div class="item"><a href="http://" target="_ablank"><img src="images/ad/diabetes-5.jpg" alt="f2Img"></a></div>
	</div>
	<!-- 轮播（Carousel）导航 -->
